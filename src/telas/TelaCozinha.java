...
public class TelaCozinha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jtAtendentes.getColumnModel().getColumnCount() > 0) {
            jtAtendentes.getColumnModel().getColumn(0).setMinWidth(80);
            jtAtendentes.getColumnModel().getColumn(0).setPreferredWidth(80);
            jtAtendentes.getColumnModel().getColumn(0).setMaxWidth(80);
            jtAtendentes.getColumnModel().getColumn(1).setMinWidth(400);
            jtAtendentes.getColumnModel().getColumn(1).setPreferredWidth(400);
            jtAtendentes.getColumnModel().getColumn(1).setMaxWidth(400);
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jbPedidoPronto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
